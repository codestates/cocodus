...
function Register({ readonly }) {
  ...
  return (
    <>
      {readonly ? (
        <Section>
          <Title type="text" placeholder="제목을 입력하세요" readOnly />
          <FlexBox>
            <Div>글쓴이</Div>
          ...
          <FlexBox>
            <Div>사용 언어</Div>
            <InputBox type="text" list="list" ri="1rem" readOnly />
            {/* {hashArr.map((el) => {
          return <div>{el}</div>;
        })} */}
            <datalist id="list">
          ...
          <FlexBox>
            <Div>일시</Div>
            <InputBox type="datetime-local" readOnly></InputBox>
          </FlexBox>
          <TestEditorForm readonly />
          <FlexBox top="2rem">
            <Div>위치</Div>
            <InputBox
              type="text"
