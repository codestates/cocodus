      ...
      [
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: false,
            tag: "JS",
            roadAddress: "서울 종로구 관훈동 인사동길 45-1",
            placeName: "오설록 티하우스 인사동점",
            lat: "37.5742461",
            long: "126.9842955",
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: true,
            tag: "JS",
            roadAddress: "서울 강남구 논현로 26길 46-8",
            placeName: "원표셰",
            lat: "37.4834906",
            long: "127.0461335",
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: true,
            tag: "Java",
            roadAddress: "서울시 양천구 목동중앙북로 54-1",
            placeName: "카페나",
            lat: "37.5471689",
            long: "127.8692508",
            date: "2022년 3월 21일 오후 8시",
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: true,
            tag: "GO",
            roadAddress: "서울시 서대문구 연희로 10길 64",
            placeName: "바벨의 도서관",
            lat: "37.5644011",
            long: "126.9327240",
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: false,
            tag: "Kotlin",
            roadAddress: "서울시 서대문구 남가좌2동 거북골로 21",
            placeName: "어라운드 스터디카페",
            lat: "37.5801071",
            long: "126.9249667",
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: true,
            tag: "Node",
            roadAddress: "서울시 서초구 방배천로4안길 61",
            placeName: "크로플마을 방배점",
            lat: "37.4807590",
            long: "126.9832508",
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: true,
            tag: "C",
            roadAddress: "서울시 관악구 봉천동 봉천로 585",
            placeName: "이알로스터즈",
            lat: "37.4769213",
            long: "126.9626380",
        ...
        },
        {
          ...
          jsonfile: JSON.stringify({
            ...
            online: false,
            tag: "Python",
            roadAddress: "서울시 강서구 개화동로 19길 18",
            placeName: "고양이정원",
            lat: "37.5756595",
            long: "126.8030663",
            date: "2022년 4월 17일 오후 8시",
          }),
          recruiting: 0,
          online: 0,
          veiw_count: 0,
